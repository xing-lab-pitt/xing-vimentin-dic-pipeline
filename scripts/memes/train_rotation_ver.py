...
def augment_images(images, masks):
    ...
    combined_imgs = [np.concatenate([images[i], masks[i]], axis=0)
    ...
    augmented_images, masks = augmented_combined_images[..., :n_ch], \
        augmented_combined_images[..., n_ch:]
...
def predict_image(image, model):
    ...
    smaller_images_2, offsets_2 = segment_image_to_small_pieces(image,
                                                                config.image_size,
                                                                config.image_size,
                                                                return_offset=True,
                                                                start_h_offset=100,
                                                                start_w_offset=0)
    smaller_images_3, offsets_3 = segment_image_to_small_pieces(image,
                                                                config.image_size,
                                                                config.image_size,
                                                                return_offset=True,
                                                                start_h_offset=0,
                                                                start_w_offset=100)
    smaller_images_4, offsets_4 = segment_image_to_small_pieces(image,
                                                                config.image_size,
                                                                config.image_size,
                                                                return_offset=True,
                                                                start_h_offset=77,
                                                                start_w_offset=77)
    smaller_images_5, offsets_5 = segment_image_to_small_pieces(image,
                                                                config.image_size,
                                                                config.image_size,
                                                                return_offset=True,
                                                                start_h_offset=33,
                                                                start_w_offset=33)
    smaller_images.extend(
        smaller_images_2 +
        smaller_images_3 +
        smaller_images_4 +
        smaller_images_5)
...
def main_pred():
    ...
    images, filenames = load_images_from_dirs(
        X_img_paths, ext='tif', return_filename=True, limit_per_dir=5)
    ...
    H, W = list((np.array(images[0].shape[:2]) //
