        ...
        for branch in all_branches:
            ...
            if branch_end_t>end_range:
                ...
                if long_traj_loss_ratio<loss_ratio_thres:
                    ...
                    traj_feature,traj_contour,traj_cord,traj_seri,traj_am_flag,traj_fluor_feature_values,traj_fluor_pca_cord=generate_fluor_long_traj(
                ...
                if branch_end_label==traj_label:
                    ...
                    with open(sct_path+'indirect_fluor_sct_XY0'+str(posi)+'_'+traj_name+'long_traj', 'wb') as fp:
                        pickle.dump(traj_sct, fp)
