            ...
            if len(all_branches)>1:
                ...
                for branch in all_branches:
                    ...
                    for sub_label in branch:
                        ...
                        if (sub_end_t-sub_start_t)>traj_len_thres and sub_start_t<begin_range and sub_end_t>end_range:
                            ...
                            if long_traj_loss_ratio<loss_ratio_thres:
                                ...
                                traj_feature,traj_contour,traj_cord,traj_seri,traj_am_flag,traj_fluor_feature_values,traj_fluor_pca_cord=generate_fluor_long_traj(df,cells,am_record,traj_df,long_traj,'vimentin',feature_list,fluor_feature_name)
