...
def traj_reconganize1(img_path, output_path, icnn_seg_weights, obj_h = 128, obj_w = 128):
...
if __name__ == "__main__":
    ...
    # arg 1 should be img path
    # arg 2 should be output path
    # arg 3 should be icnn_seg_weights
    traj_reconganize1(sys.argv[1], sys.argv[2], sys.argv[3])
