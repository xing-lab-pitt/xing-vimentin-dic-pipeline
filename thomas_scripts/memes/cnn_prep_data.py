...
def prep_icnn_seg_train_data_reduc_aug(img_path, obj_h, obj_w, classes=["single_cell", "cell_fragment", "multi_cells"]):
    data = []
    label = []
...
def prep_icnn_am_train_data_reduc_aug(img_path, obj_h, obj_w):
    """
    img_path: a folder contining the /other, /apoptosis, /mitosis folders.
    obj_h and obj_w is defined dimention of input pictures.
    """
